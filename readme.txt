...
2. Type in Fast Blog in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.
4. Navigate to Appearance > Customize in your admin panel and customize to taste.

== Copyright ==

FastBlog WordPress Theme, Copyright 2017 Jitesh Patil
FastBlog is distributed under the terms of the GNU GPL
...
- Fixes hero area display issue.

= 1.6.4 =
* Released: April 07, 2018

- Code improvements to confirm to WordPress-VIP standards.

= 1.6.3 =
* Released: March 24, 2018

- Adds white space to all list items.

= 1.6.2 =
* Released: March 17, 2018

- Adds Mailerlite styles.
- Fixes in-content row and column styles.
- Fixes active callback for hero area background image option.
- Fixes padding in entry index & adds a border below each entry.
...
- Adds a 'Theme Options' panel to the customizer.
...
- Makes gutter with 48px instead of 30px.

= 1.5.6 =
* Released: March 5, 2018

- Add support for button-min class.
- Fixes site header text color issue.

= 1.5.5 =
* Released: March 5, 2018

- Wide canvas template for Elementor.
- Wide no site header template for Elementor.
- Wide no primary menu template for Elementor.

= 1.5.4 =
* Released: March 4, 2018

- Fixes headings in archive pages.
- Fixes contact form 7 styles.
- Fixes input, select, textarea custom font style.
...
- Adds styles for underline & highlight.
...
- Supports author biography.
- Uses bottom border instead of text-decoration underline for anchor links.
...
- Fixes enqueuing Google fonts in editor stylesheet
- Fixes excerpt length so that it is changed only in the front end
- Fixes customizer styles so that they are added with 'wp_add_inline_style'
